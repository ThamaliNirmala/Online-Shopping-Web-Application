...
<?php
	...
	require "config.php";
	echo "<center><h1>Knife Database</h1></center>";
	$sql = "SELECT * FROM knifedb";
...
<!---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
	<br><br><br><br><br><br>		
		<div>
			...
			<form method = "post" target = "_self" action = "updateItemsK.php">
	...
	<div>
			...
			<form method = "post" target = "_self" action = "addItemsK.php">
	...
	<div>
			...
			<form method = "post" target = "_self" action = "deleteItemsK.php">
