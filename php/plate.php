...
<?php
	...
	require "config.php";
	echo "<center><h1>Plate Database</h1></center>";
	$sql = "SELECT * FROM platedb";
...
<!---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
	<br><br><br><br><br><br>		
		<div>
			...
			<form method = "post" target = "_self" action = "updateItemsP.php">
	...
	<div>
			...
			<form method = "post" target = "_self" action = "addItemsP.php">
	...
	<div>
			...
			<form method = "post" target = "_self" action = "deleteItemsP.php">
