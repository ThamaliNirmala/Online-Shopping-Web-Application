...
<?php
	...
	require "config.php";
	echo "<center><h1>Skin Database</h1></center>";
	$sql = "SELECT * FROM skindb";
...
<!---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
	<br><br><br><br><br><br>		
		<div>
			...
			<form method = "post" target = "_self" action = "updateItemsS.php">
	...
	<div>
			...
			<form method = "post" target = "_self" action = "addItemsS.php">
	...
	<div>
			...
			<form method = "post" target = "_self" action = "deleteItemsS.php">
