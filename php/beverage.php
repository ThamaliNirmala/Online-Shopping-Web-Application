...
<div class="topnav">
  ...
  <a class="active zoom" class="html/active zoom" href="../html/admin.html">Administrator</a>
...
<?php
	...
	require "config.php";
	echo "<center><h1>Beverage Database</h1></center>";
	$sql = "SELECT * FROM beveragedb";
...
<!---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
	<br><br><br><br><br><br>		
		<div>
			...
			<form method = "post" target = "_self" action = "updateItemsB.php">
	...
	<div>
			...
			<form method = "post" target = "_self" action = "addItemsB.php">
	...
	<div>
			...
			<form method = "post" target = "_self" action = "deleteItemsB.php">
