...
<body>
<form name='frmUser' method='post' action='../php/login.php' style = 'margin-top:200px'>
...
";
		...
		<a href = '../html/payment.html'><button class = 'button0 button1'>Click to Proceed</button></a></center>
